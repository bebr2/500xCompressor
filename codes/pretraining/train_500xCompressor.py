...
class TextDataset(Dataset):
    def __init__(self, text_file, llama_path, max_length, eos_token_id):
        """
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train 500xCompressor pretraining model")
    ...
    parser.add_argument("--project_name", type=str, default="500xCompressor-pretraining",
...
if __name__ == "__main__":
    ...
    train_dataset = TextDataset(args.train_text_path, args.model_path, args.max_length, eos_token_id)
    test_dataset = TextDataset(args.test_text_path, args.model_path, args.max_length, eos_token_id)
