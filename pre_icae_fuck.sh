...
deepspeed  --master_port=11470 train_ICAE.py \
    ...
    --output_dir /mnt/hdfs/wangchangyue/500xCompressor/output/ICAE_pretrain-Qwen3-8B-2 \
    --logging_dir /mnt/hdfs/wangchangyue/500xCompressor/logs/ICAE_pretrain-Qwen3-8B-2 \
