...
deepspeed  --master_port=11470 train_500xCompressor.py \
    ...
    --output_dir /mnt/hdfs/wangchangyue/500xCompressor/output/500xCompressor_pretrain-Qwen3-8B \
    --logging_dir /mnt/hdfs/wangchangyue/500xCompressor/logs/500xCompressor_pretrain-Qwen3-8B \
