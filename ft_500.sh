...
python convert_checkpoint.py /mnt/hdfs/wangchangyue/500xCompressor/output/500xCompressor_pretrain-Qwen3-8B
...
deepspeed  --master_port=11470 finetune_500xCompressor.py \
    ...
    --output_dir /mnt/hdfs/wangchangyue/500xCompressor/output/500xCompressor_finetune-Qwen3-8B \
    --logging_dir /mnt/hdfs/wangchangyue/500xCompressor/logs/500xCompressor_finetune-Qwen3-8B \
